...
public class LottoChip {
	private String id,ChipLv,ChipType,SingleOdds,Odds1,Odds2,Odds3,Odds4,Odds5,Odds6,Odds7,Odds8,Odds9,Odds10,TemplateId;
	...
	public String getChipLv() {
		return ChipLv;
	}

	public void setChipLv(String chipLv) {
		ChipLv = chipLv;
	}
